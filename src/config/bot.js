...
export const botConfig = {
  ...
  applications: {
    ...
    defaultQuestions: [
      ...
      { question: "What can you contribute to the community?", required: true },
      { question: "Do you have any prior experience?", required: true },
      { question: "Any additional comments?", required: false },
      { question: "Have you read and agreed to the server rules?", required: true },
    ],
